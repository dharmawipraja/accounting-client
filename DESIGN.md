...
- *"Reading this as: redesign of a public-sector service site, with a trust-first language, leaning toward [GOV.UK](http://GOV.UK) Frontend or USWDS."*
...
export function HorizontalPan({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      [gsap.to](http://gsap.to)(track.current, {
...
export function RevealStagger({ items }: { items: string[] }) {
  ...
  return (
    ...
    <ul className="grid gap-6">
      ...
      {[items.map](http://items.map)((item, i) => (

        <[motion.li](http://motion.li)
...
skills/taste-skill/blocks/
  ...
  hero/
    ...
    [asymmetric-split.md](http://asymmetric-split.md)

    [editorial-manifesto.md](http://editorial-manifesto.md)

    [kinetic-type.md](http://kinetic-type.md)

    ...

  feature/

    [bento-grid.md](http://bento-grid.md)

    [sticky-scroll-stack.md](http://sticky-scroll-stack.md)

    [zig-zag.md](http://zig-zag.md)
...
#   <script src="[https://cdn.shopify.com/shopifycloud/polaris.js"></script>](https://cdn.shopify.com/shopifycloud/polaris.js"></script>)
...
- [https://material-web.dev/theming/material-theming/](https://material-web.dev/theming/material-theming/)

- [https://m3.material.io/develop/web](https://m3.material.io/develop/web)

### Fluent UI

- [https://fluent2.microsoft.design/get-started/develop](https://fluent2.microsoft.design/get-started/develop)

- [https://fluent2.microsoft.design/components/web/react/](https://fluent2.microsoft.design/components/web/react/)
...
- [https://carbondesignsystem.com/developing/react-tutorial/overview/](https://carbondesignsystem.com/developing/react-tutorial/overview/)

- [https://carbondesignsystem.com/developing/web-components-tutorial/overview/](https://carbondesignsystem.com/developing/web-components-tutorial/overview/)

### Shopify Polaris

- [https://shopify.dev/docs/api/app-home/web-components](https://shopify.dev/docs/api/app-home/web-components)

- [https://github.com/Shopify/polaris-react](https://github.com/Shopify/polaris-react)

- [https://polaris-react.shopify.com/components](https://polaris-react.shopify.com/components)

### Atlassian

- [https://atlassian.design/get-started/develop](https://atlassian.design/get-started/develop)

- [https://atlassian.design/components/button/examples](https://atlassian.design/components/button/examples)

- [https://atlaskit.atlassian.com/packages/design-system/button/example/disabled](https://atlaskit.atlassian.com/packages/design-system/button/example/disabled)

- [https://atlassian.design/tokens/design-tokens](https://atlassian.design/tokens/design-tokens)
...
- [https://github.com/primer/brand](https://github.com/primer/brand)
...
- [https://designsystem.digital.gov/documentation/developers/](https://designsystem.digital.gov/documentation/developers/)

- [https://designsystem.digital.gov/components/button/](https://designsystem.digital.gov/components/button/)

- [https://designsystem.digital.gov/components/card/](https://designsystem.digital.gov/components/card/)
...
- [https://www.radix-ui.com/themes/docs/components/theme](https://www.radix-ui.com/themes/docs/components/theme)

- [https://www.radix-ui.com/themes/docs/components/card](https://www.radix-ui.com/themes/docs/components/card)
...
- [https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/backdrop-filter](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/backdrop-filter)

- [https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/At-rules/@media/prefers-color-scheme](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/At-rules/@media/prefers-color-scheme)
...
- [https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Scroll-driven_animations](https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Scroll-driven_animations)

- [https://drafts.csswg.org/scroll-animations-1/](https://drafts.csswg.org/scroll-animations-1/)
...
- [https://developer.apple.com/documentation/SwiftUI/Material](https://developer.apple.com/documentation/SwiftUI/Material)
