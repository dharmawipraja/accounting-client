...
const testApi = createDocumentHooks<TestItem, TestCreate, Partial<TestCreate>>({ keys: createResourceKeys('test-docs'), basePath: '/test-docs', itemSchema: testItemSchema });
