            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Post all pending ledger entries to the general ledger for the specified date
                        </CardDescription>
                    </CardHeader>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-3">
                            <h4 className="font-medium text-gray-900">What is Buku Besar Posting?</h4>
                            <p className="text-sm text-gray-600">
                                Buku Besar (General Ledger) posting transfers all pending ledger entries
                                to the posted status, making them part of the official accounting records.
                            </p>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="text-sm text-gray-600 space-y-1">
                                <li>• All PENDING ledger entries for the date are marked as POSTED</li>
                                <li>• Account balances are updated with the posted amounts</li>
                                <li>• The posting timestamp is recorded for audit purposes</li>
                                <li>• Posted entries become immutable and part of the official record</li>
                            </ul>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-sm text-gray-600">
                                Unposting reverses the posting operation and returns entries to PENDING status.
                                Use this only when corrections are needed before month-end closing.
                            </p>
                        </div>
                        ...
                        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                            ...
                            <p className="text-sm text-amber-700 mt-1">
                                ...
                                Unposting should be done carefully as it affects financial reporting.
                            </p>
                        </div>
                    </CardContent>
                </Card>
