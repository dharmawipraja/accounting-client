...
export function NeracaBalancePostingPage() {
    ...
    const [calculationDate, setCalculationDate] = useState<string>(getCurrentDateForAPI())
                        ...
                        {calculationError && (
                            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-medium text-red-800">Calculation Error</span>
                                </div>
                                <p className="text-sm text-red-700 mt-1">
                                    Unable to calculate balance. Please check the date and try again.
                                </p>
                            </div>
                        )}
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-1 gap-3">
                                    ...
                                    <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                                        <span className="font-medium text-green-900">Total Equity</span>
                                    ...
                                    <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                                        <span className="font-medium text-purple-900">Sisa Hasil Usaha</span>
                                ...
                                <div className="flex items-center gap-2 p-3 border rounded-lg">
                                    ...
                                    <span className={`font-medium ${balance.isBalanced ? 'text-green-800' : 'text-red-800'
                                        }`}>
                                        Balance Status: {balance.isBalanced ? 'Balanced' : 'Not Balanced'}
                                    </span>
                                </div>

                                <p className="text-xs text-gray-500">
                                    Calculated on: {new Date(balance.calculatedAt).toLocaleString()}
                                </p>
                            </div>
                        )}
                    </CardContent>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-6">
                        <form onSubmit={form.handleSubmit(onSubmitPost)} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="sisaHasilUsahaAmount">Sisa Hasil Usaha Amount</Label>
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        {...form.register('sisaHasilUsahaAmount', { valueAsNumber: true })}
                                        className="pl-10"
                                        disabled={postMutation.isPending}
                                    />
                                </div>
                        ...
                        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                            ...
                            <p className="text-sm text-amber-700 mt-1">
                                Ensure you have calculated and verified the balance before posting.
                                The SHU amount should match your calculation results.
                            </p>
                        </div>
                    </CardContent>
                </Card>
