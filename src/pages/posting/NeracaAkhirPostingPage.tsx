                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-medium text-red-800">Final Step Warning</span>
                            </div>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-3">
                            <h4 className="font-medium text-gray-900">What is Neraca Akhir Posting?</h4>
                            <p className="text-sm text-gray-600">
                                Neraca Akhir (Final Balance Sheet) posting is the last step in the
                                accounting period closure process. It creates the official final
                                balance sheet that will be used for financial reporting.
                            </p>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-sm text-gray-600">
                                ...
                                closed. Any subsequent adjustments will require special procedures
                                and approvals.
                            </p>
                        </div>
                        ...
                        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-medium text-amber-800">Period Closure</span>
                            </div>
