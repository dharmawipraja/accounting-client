...
// Delimiter is ';' — Indonesian-locale Excel (the finance team's environment)
// uses ',' as the DECIMAL symbol and ';' as the list separator, so a
// comma-delimited file double-clicked open lands in a single column.
it('joins headers and rows with CRLF using the ; delimiter', () => {
  expect(toCsv(['a', 'b'], [['1', '2'], ['3', '4']])).toBe('a;b\r\n1;2\r\n3;4');
});

it('quotes cells containing the delimiter, comma, quote, or newline and escapes inner quotes', () => {
